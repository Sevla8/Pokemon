...
-- Bastien Thouverez
-- Modifications et compléments apportés par Sevla

DROP TABLE IF EXISTS pokemon, dresseur, capacite, detient_pokemon, est_type, evolu_en, possede_capacite;
...
CREATE TABLE possede_capacite (
	id_pok int NOT NULL, 
	id_capa_1 varchar(25) NOT NULL,  
	id_capa_2 varchar(25) NOT NULL,
	id_capa_3 varchar(25) NOT NULL,
	id_capa_4 varchar(25) NOT NULL,
	FOREIGN KEY(id_capa_1) REFERENCES capacite(id_capa),
	FOREIGN KEY(id_capa_2) REFERENCES capacite(id_capa),
	FOREIGN KEY(id_capa_3) REFERENCES capacite(id_capa),
	FOREIGN KEY(id_capa_4) REFERENCES capacite(id_capa),
	FOREIGN KEY(id_pok) REFERENCES pokemon(id_pok)
);
